  ...
  <div>
    ...
    <form @submit.prevent="handleLogin" class="space-y-5">
      ...
      <div>
        <div class="flex items-center justify-between mb-2">
          <label class="text-sm font-medium text-surface-700">Mot de passe</label>
          <RouterLink to="/auth/forgot-password" class="text-sm text-primary-600 hover:text-primary-700 font-medium">
            Oublié ?
          </RouterLink>
        </div>
        <div class="relative">
    ...
    <div class="relative my-8">
      ...
      <div class="relative flex justify-center text-sm">
        <span class="px-4 bg-white text-surface-500">ou continuer avec</span>
      </div>
    </div>
    ...
    <div class="grid grid-cols-2 gap-3">
      <button
        ...
        class="btn-secondary !py-3 text-sm"
      >
    ...
    <p class="text-center text-sm text-surface-500 mt-8">
      ...
      <RouterLink to="/auth/signup" class="text-primary-600 font-semibold hover:text-primary-700">
        Créer un compte
      </RouterLink>
    </p>
  </div>
